...
public class HttpRequest {
    ...
    HttpRequest(final String url, final HttpMethod method) {
        fullLogEnable = System.getProperties().containsKey("ws.loggger.enable")
                ? Boolean.parseBoolean(System.getProperty("ws.loggger.enable"))
                : false;
    ...
    public HttpResponseWrapper sendRequestWithRetry(final int retryCount, final int statusCode) throws InterruptedException {
    ...
    public HttpResponseWrapper sendRequestWithRetry(final int retryCount, List<Integer> expectedStatusCodes) throws InterruptedException {
        HttpResponseWrapper response = null;
