package com.test.vvoicu.plugin;

import com.test.vvoicu.testrail.APIClient;
import com.test.vvoicu.testrail.APIException;
import com.test.vvoicu.testrail.ResponderUtils;
...
import static org.seleniumhq.jetty9.util.log.Log.getLog;
...
public class TestRailReportingMojo extends AbstractMojo {
	...
	private String testRailBaseUrl = "https://takeofftech.testrail.net";
	private String testRailUsername = "borys.nazaruk@takeoff.com";
	private String testRailPassword = "Amsterdam12#$";
